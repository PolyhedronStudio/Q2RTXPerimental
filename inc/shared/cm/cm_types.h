...
*   ContentMask Sets:
**/
#define CM_CONTENTMASK_SOLID              /*cm_contents_t*/( CONTENTS_SOLID | CONTENTS_WINDOW | CONTENTS_DETAIL )
#define CM_CONTENTMASK_PLAYERSOLID        /*cm_contents_t*/( CONTENTS_SOLID | CONTENTS_PLAYERCLIP | CONTENTS_WINDOW | CONTENTS_MONSTER | CONTENTS_PLAYER | CONTENTS_DETAIL )
#define CM_CONTENTMASK_DEADSOLID          /*cm_contents_t*/( CONTENTS_SOLID | CONTENTS_PLAYERCLIP | CONTENTS_WINDOW | CONTENTS_DETAIL )
#define CM_CONTENTMASK_MONSTERSOLID       /*cm_contents_t*/( CONTENTS_SOLID | CONTENTS_MONSTERCLIP | CONTENTS_WINDOW | CONTENTS_MONSTER | CONTENTS_PLAYER | CONTENTS_DETAIL )
#define CM_CONTENTMASK_LIQUID              /*cm_contents_t*/( CONTENTS_WATER | CONTENTS_LAVA | CONTENTS_SLIME )
#define CM_CONTENTMASK_OPAQUE             /*cm_contents_t*/( CONTENTS_SOLID | CONTENTS_SLIME | CONTENTS_LAVA | CONTENTS_DETAIL )
#define CM_CONTENTMASK_SHOT               /*cm_contents_t*/( CONTENTS_SOLID | CONTENTS_MONSTER | CONTENTS_PLAYER | CONTENTS_WINDOW | CONTENTS_DEADMONSTER | CONTENTS_DETAIL )
