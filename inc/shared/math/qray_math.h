...
// Clamp float value
RMAPI float QM_Clamp(float value, float min, float max)
{
...
RMAPI float QM_Lerp(float start, float end, float amount)
{
...
RMAPI float QM_Normalize(float value, float start, float end)
{
...
RMAPI float QM_Remap(float value, float inputStart, float inputEnd, float outputStart, float outputEnd)
{
...
RMAPI float QM_Wrap(float value, float min, float max)
{
...
RMAPI int QM_FloatEquals(float x, float y)
{
...
// Add two vectors
RMAPI Vector3 QM_Vector3Add(Vector3 v1, Vector3 v2)
{
...
// Add vector and float value
RMAPI Vector3 QM_Vector3AddValue(Vector3 v, float add)
{
...
RMAPI Vector3 QM_Vector3Subtract(Vector3 v1, Vector3 v2)
{
    Vector3 result = { v1.x - v2.x, v1.y - v2.y, v1.z - v2.z };
...
// Subtract vector by float value
RMAPI Vector3 QM_Vector3SubtractValue(Vector3 v, float sub)
{
...
RMAPI Vector3 QM_Vector3Scale(Vector3 v, float scalar)
{
...
// Multiply vector by vector
RMAPI Vector3 QM_Vector3Multiply(Vector3 v1, Vector3 v2)
{
    Vector3 result = { v1.x*v2.x, v1.y*v2.y, v1.z*v2.z };
...
RMAPI Vector3 QM_Vector3CrossProduct(Vector3 v1, Vector3 v2)
{
...
RMAPI Vector3 QM_Vector3Perpendicular(Vector3 v)
{
    Vector3 result = { 0 };
...
// Calculate vector length
RMAPI float QM_Vector3Length(const Vector3 v)
{
...
// Calculate vector square length
RMAPI float QM_Vector3LengthSqr(const Vector3 v)
{
...
// Calculate two vectors dot product
RMAPI float QM_Vector3DotProduct(Vector3 v1, Vector3 v2)
{
...
// Calculate distance between two vectors
RMAPI float QM_Vector3Distance(Vector3 v1, Vector3 v2)
{
    float result = 0.0f;
...
// Calculate square distance between two vectors
RMAPI float QM_Vector3DistanceSqr(Vector3 v1, Vector3 v2)
{
    float result = 0.0f;
...
// Calculate angle between two vectors
RMAPI float QM_Vector3Angle(Vector3 v1, Vector3 v2)
{
    float result = 0.0f;
...
RMAPI Vector3 QM_Vector3Negate(Vector3 v)
{
...
// Divide vector by vector
RMAPI Vector3 QM_Vector3Divide(Vector3 v1, Vector3 v2)
{
    Vector3 result = { v1.x/v2.x, v1.y/v2.y, v1.z/v2.z };
...
RMAPI Vector3 QM_Vector3DivideValue( Vector3 v1, const float scalar ) {
...
// Normalize provided vector
RMAPI Vector3 QM_Vector3Normalize(Vector3 v)
{
    Vector3 result = v;
...
RMAPI Vector3 QM_Vector3Project(Vector3 v1, Vector3 v2)
{
    Vector3 result = { 0 };
...
RMAPI Vector3 QM_Vector3Reject(Vector3 v1, Vector3 v2)
{
    Vector3 result = { 0 };
...
RMAPI Vector3 QM_Vector3Transform(Vector3 v, Matrix mat)
{
    Vector3 result = { 0 };
...
RMAPI Vector3 QM_Vector3RotateByQuaternion(Vector3 v, Quaternion q)
{
    Vector3 result = { 0 };
...
RMAPI Vector3 QM_Vector3RotateByAxisAngle(Vector3 v, Vector3 axis, float angle)
{
...
// Calculate linear interpolation between two vectors
RMAPI Vector3 QM_Vector3Lerp(Vector3 v1, Vector3 v2, float amount)
{
    Vector3 result = { 0 };
...
// Calculate reflected vector to normal
RMAPI Vector3 QM_Vector3Reflect(Vector3 v, Vector3 normal)
{
    Vector3 result = { 0 };
...
RMAPI Vector3 QM_Vector3Min(Vector3 v1, Vector3 v2)
{
    Vector3 result = { 0 };
...
RMAPI Vector3 QM_Vector3Max(Vector3 v1, Vector3 v2)
{
    Vector3 result = { 0 };
...
RMAPI Vector3 QM_Vector3Barycenter(Vector3 p, Vector3 a, Vector3 b, Vector3 c)
{
    Vector3 result = { 0 };
...
RMAPI Vector3 QM_Vector3Unproject(Vector3 source, Matrix projection, Matrix view)
{
    Vector3 result = { 0 };
...
RMAPI float3 QM_Vector3ToFloatV(Vector3 v)
{
    float3 buffer = { 0 };
...
// Invert the given vector
RMAPI Vector3 QM_Vector3Invert(Vector3 v)
{
...
// Clamp the components of the vector between
// min and max values specified by the given vectors
RMAPI Vector3 QM_Vector3Clamp(Vector3 v, Vector3 min, Vector3 max)
{
    Vector3 result = { 0 };
...
RMAPI Vector3 QM_Vector3ClampValue(Vector3 v, float min, float max)
{
    Vector3 result = v;
...
// Check whether two given vectors are almost equal
RMAPI int QM_Vector3Equals(Vector3 p, Vector3 q)
{
#if !defined(QM_EPSILON)
    #define QM_EPSILON 0.000001f
#endif
...
RMAPI Vector3 QM_Vector3Refract(Vector3 v, Vector3 n, float r)
{
    Vector3 result = { 0 };
