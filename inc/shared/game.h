...
////////////////////////////////////////////////////////////////////////////
//
// Functions exported by the server to the Mono Game Subsystem.
//
typedef struct {
    // special messages
    void (* BPrint)( int printlevel, const char *str );
    void (* DevPrint)( const char *str );
    void (* CPrint)( edict_t *ent, int printlevel, const char *str );
    void (* CenterPrint)( edict_t *ent, const char *str );
} mono_game_import_t;
