...
#define PS_M_ORIGIN1		(1<<1)
#define PS_M_ORIGIN2		(1<<2)
#define PS_M_ORIGIN3		(1<<3)
#define PS_M_VELOCITY1		(1<<4)
#define PS_M_VELOCITY2		(1<<5)
#define PS_M_VELOCITY3		(1<<6)
#define PS_M_TIME           (1<<7)
#define PS_M_FLAGS          (1<<8)
#define PS_M_GRAVITY        (1<<9)
#define PS_M_DELTA_ANGLES   (1<<10)

#define PS_VIEWOFFSET       (1<<11)
#define PS_VIEWANGLES       (1<<12)
#define PS_KICKANGLES       (1<<13)
#define PS_BLEND            (1<<14)
#define PS_FOV              (1<<15)
#define PS_WEAPONINDEX      (1<<16)
#define PS_WEAPONFRAME      (1<<17)
#define PS_RDFLAGS          (1<<18)
#define PS_WEAPONRATE       (1<<19)
