...
#define MAX_PACKET_USERCMDS     128
#define MAX_PACKET_FRAMES       16
...
#define PS_BOB_CYCLE		(1<<6)
#define PS_M_VIEWHEIGHT		(1<<7)
#define PS_VIEWANGLES       (1<<8)
#define PS_KICKANGLES       (1<<9)
#define PS_VIEWOFFSET       (1<<10)
#define PS_BLEND            (1<<11)
#define PS_GUN_ANIMATION	(1<<12)
#define PS_GUN_MODELINDEX	(1<<13)
#define PS_FOV					(1<<14)
#define PS_M_EVENT_SEQUENCE		(1<<15)
#define PS_M_EVENT_FIRST		(1<<16)
#define PS_M_EVENT_FIRST_PARM	(1<<17)
#define PS_M_EVENT_SECOND		(1<<18)
#define PS_M_EVENT_SECOND_PARM	(1<<19)
#define PS_RDFLAGS				(1<<20)
#define PS_M_GRAVITY			(1<<21)
