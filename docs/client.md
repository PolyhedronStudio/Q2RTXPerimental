...
Heads up display configuration cvars.
...
#### `pt_enable_nodraw`
When this cvar is set to 1, BSP surfaces marked with the `CM_SURFACE_NODRAW` flag
...
If set to 2, removes all `CM_SURFACE_NODRAW` surfaces, including those with a
