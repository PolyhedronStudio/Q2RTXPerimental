...
void CM_InitBoxHullState( hull_boundingbox_t *hull ) {
    ...
    **/
    ...
    hull->headnode->synthetic_hull_type = 1; // 1 = Bounding Box Hull
...
mnode_t *CM_HeadnodeForBox( cm_t *cm, const vec3_t mins, const vec3_t maxs, const cm_contents_t contents ) {
    ...
    **/
    ...
    CM_SetupBoxHull( hull, mins, maxs, contents );
...
const bool CM_IsBoundingBoxHullHeadnode( const cm_t *cm, const mnode_t *headnode ) {
    return headnode && headnode->synthetic_hull_type == 1;
}
