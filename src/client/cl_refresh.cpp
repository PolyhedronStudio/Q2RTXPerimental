...
void( *R_DrawFill8f )( float x, float y, float w, float h, int c ) = NULL;
void( *R_DrawFill32f )( float x, float y, float w, float h, uint32_t color ) = NULL;
void( *R_DrawDebugBox )( const vec3_t mins, const vec3_t maxs, uint32_t color, const float thickness, const float outline_thickness, const uint16_t style_flags ) = NULL;
void( *R_DrawDebugLine )( const vec3_t start, const vec3_t end, uint32_t color, const float thickness, const float outline_thickness, const uint16_t style_flags ) = NULL;
void( *R_DrawDebugArrow )( const vec3_t start, const vec3_t end, float head_length, uint32_t color, const float thickness, const float outline_thickness, const uint16_t style_flags ) = NULL;
void( *R_DrawDebugSphere )( const vec3_t center, float radius, uint32_t color, const float thickness, const float outline_thickness, const uint16_t style_flags ) = NULL;
void( *R_DrawDebugCapsule )( const vec3_t start, const vec3_t end, float radius, uint32_t color, const float thickness, const float outline_thickness, const uint16_t style_flags ) = NULL;
void( *R_DrawDebugCylinder )( const vec3_t start, const vec3_t end, float radius, uint32_t color, const float thickness, const float outline_thickness, const uint16_t style_flags ) = NULL;
...
void( *R_DumpDecalMaterialMappings )( void ) = NULL;
