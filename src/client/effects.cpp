...
{
	static constexpr int32_t lightStyleFrameTime = 100;
    int     i, ofs = cl.time / lightStyleFrameTime;
    clightstyle_t   *ls;
...
void CL_MuzzleFlash(void)
{
    ...
    pl = ENTITY_FOR_NUMBER( mz.entity ); // pl = &cl_entities[ mz.entity ];
...
void CL_MuzzleFlash2(void)
{
    ...
    // locate the origin
    ent = ENTITY_FOR_NUMBER( mz.entity );//ent = &cl_entities[mz.entity];
