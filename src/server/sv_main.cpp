...
static void SV_ConnectionlessPacket(void)
{
    ...
    MSG_BeginReadingOOB();
    int32_t skipByte = MSG_ReadBits( 32 );//MSG_ReadInt32(); // skip the -1 marker
...
void SV_Init(void) {
...
#if USE_DEBUG
    sv_debug = Cvar_Get("sv_debug", "1", 0); // WID: netstuff: Enable by default if debug build.
    ...
    sv_cinematics = Cvar_Get("sv_cinematics", "0", CVAR_ROM );
