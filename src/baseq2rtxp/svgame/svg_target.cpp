...
"style"     type byte
*/
void Use_Target_Tent( svg_entity_t *ent, svg_entity_t *other, svg_entity_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
...
*/
void Use_Target_Speaker( svg_entity_t *ent, svg_entity_t *other, svg_entity_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
    int     chan;
...
*/
void use_target_secret( svg_entity_t *ent, svg_entity_t *other, svg_entity_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
...
These are single use targets.
*/
void use_target_goal( svg_entity_t *ent, svg_entity_t *other, svg_entity_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
    gi.sound(ent, CHAN_VOICE, ent->noise_index, 1, ATTN_NORM, 0);
...
*/
void target_explosion_explode(svg_entity_t *self)
{
    float       save;
...
void use_target_explosion( svg_entity_t *self, svg_entity_t *other, svg_entity_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
...
*/
void use_target_changelevel( svg_entity_t *self, svg_entity_t *other, svg_entity_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
...
void use_target_splash( svg_entity_t *self, svg_entity_t *other, svg_entity_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
    gi.WriteUint8(svc_temp_entity);
...
void SP_target_splash(svg_entity_t *self)
{
...
void use_target_spawner( svg_entity_t *self, svg_entity_t *other, svg_entity_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
    svg_entity_t *ent;
...
void SP_target_spawner(svg_entity_t *self)
{
...
void use_target_blaster( svg_entity_t *self, svg_entity_t *other, svg_entity_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
#if 0
    int effect;
...
void SP_target_blaster(svg_entity_t *self)
{
...
*/
void trigger_crosslevel_trigger_use( svg_entity_t *self, svg_entity_t *other, svg_entity_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
    game.serverflags |= static_cast<crosslevel_target_flags_t>( self->spawnflags );
    SVG_FreeEdict(self);
}

void SP_target_crosslevel_trigger(svg_entity_t *self)
{
    self->svflags = SVF_NOCLIENT;
...
*/
void target_crosslevel_target_think(svg_entity_t *self)
{
...
void SP_target_crosslevel_target(svg_entity_t *self)
{
    if (! self->delay)
        self->delay = 1;
    self->svflags = SVF_NOCLIENT;
...
void target_laser_think(svg_entity_t *self)
{
    svg_entity_t *ignore;
    vec3_t  start;
    vec3_t  end;
...
void target_laser_on(svg_entity_t *self)
{
    if (!self->activator)
        self->activator = self;
...
void target_laser_off(svg_entity_t *self)
{
    self->spawnflags &= ~1;
    self->svflags |= SVF_NOCLIENT;
    self->nextthink = 0_ms;
...
void target_laser_use( svg_entity_t *self, svg_entity_t *other, svg_entity_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
    self->activator = activator;
...
void target_laser_start(svg_entity_t *self)
{
    svg_entity_t *ent;
...
void target_lightramp_think(svg_entity_t *self)
{
    char    style[2];
...
void target_lightramp_use( svg_entity_t *self, svg_entity_t *other, svg_entity_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
    if (!self->enemy) {
        svg_entity_t     *e;
...
void target_earthquake_think(svg_entity_t *self)
{
    int     i;
    svg_entity_t *e;
...
void target_earthquake_use( svg_entity_t *self, svg_entity_t *other, svg_entity_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
...
void SP_target_earthquake(svg_entity_t *self)
{
    if (!self->targetname)
