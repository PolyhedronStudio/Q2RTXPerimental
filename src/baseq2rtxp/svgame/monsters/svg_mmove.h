...
**/
const svg_trace_t SVG_MMove_Trace( const Vector3 &start, const Vector3 &mins, const Vector3 &maxs, const Vector3 &end, svg_edict_t *passEntity, cm_contents_t contentMask = CONTENTS_NONE );
