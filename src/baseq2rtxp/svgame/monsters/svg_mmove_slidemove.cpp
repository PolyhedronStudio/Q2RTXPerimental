...
**/
const int32_t SVG_MMove_SlideMove( Vector3 &origin, Vector3 &velocity, const float frametime, const Vector3 &mins, const Vector3 &maxs, svg_entity_t *passEntity, mm_touch_trace_list_t &touch_traces, const bool has_time ) {
	Vector3 dir = {};
