...
*/
void train_next( svg_base_edict_t *self );

void train_blocked( svg_base_edict_t *self, svg_base_edict_t *other ) {
...
void train_wait( svg_base_edict_t *self ) {
...
again:
    ...
    CalculateDirectionalMove( dest, train_wait );
    self->spawnflags |= TRAIN_START_ON;
}
...
void func_train_find( svg_base_edict_t *self ) {
    svg_base_edict_t *ent;
...
void train_use( svg_base_edict_t *self, svg_base_edict_t *other, svg_base_edict_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
...
void SP_func_train( svg_base_edict_t *self ) {
