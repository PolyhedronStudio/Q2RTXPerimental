...
*   @brief  
**/
void _become_( svg_entity_t *self ) {
...
*   @brief
**/
void func_breakable_explode( svg_entity_t *self, svg_entity_t *inflictor, svg_entity_t *attacker, int damage, vec3_t point ) {
...
**/
void func_breakable_use( svg_entity_t *self, svg_entity_t *other, svg_entity_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
    func_breakable_explode( self, other, activator, self->health, self->s.origin );
}
/**
*   @brief  Pain handling.
**/
void func_breakable_pain( svg_entity_t *self, svg_entity_t *other, float kick, int damage ) {
...
*   @brief
**/
void func_breakable_spawn_on_trigger( svg_entity_t *self, svg_entity_t *other, svg_entity_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
...
*
**/
void SP_func_( svg_entity_t *self );
