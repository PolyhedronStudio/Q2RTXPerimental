...
**/
static void func_wall_turn_on( svg_base_edict_t *self ) {
...
**/
static void func_wall_turn_off( svg_base_edict_t *self ) {
...
**/
static void func_wall_toggle( svg_base_edict_t *self ) {
...
*   @brief
**/
void func_wall_use( svg_base_edict_t *self, svg_base_edict_t *other, svg_base_edict_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
    //
    // usetype: TOGGLE
    //
