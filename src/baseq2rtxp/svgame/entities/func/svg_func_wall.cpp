...
**/
static void func_wall_turn_on( svg_edict_t *self ) {
...
**/
static void func_wall_turn_off( svg_edict_t *self ) {
...
**/
static void func_wall_toggle( svg_edict_t *self ) {
...
*   @brief
**/
void func_wall_use( svg_edict_t *self, svg_edict_t *other, svg_edict_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
    //
    // usetype: TOGGLE
    //
