...
struct svg_func_plat_t : public svg_pushmove_edict_t {
    ...
    **/
    ...
    DECLARE_MEMBER_CALLBACK_THINK( svg_func_plat_t, onThink_OpenMove );
    DECLARE_MEMBER_CALLBACK_THINK( svg_func_plat_t, onThink_CloseMove );
    ...
    **/
    DECLARE_MEMBER_CALLBACK_PUSHMOVE_ENDMOVE( svg_func_plat_t, onCloseEndMove );
    DECLARE_MEMBER_CALLBACK_PUSHMOVE_ENDMOVE( svg_func_plat_t, onOpenEndMove );
