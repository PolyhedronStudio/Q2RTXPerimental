...
*	@brief
**/
void trigger_push_touch( svg_base_edict_t *self, svg_base_edict_t *other, const cm_plane_t *plane, cm_surface_t *surf ) {
...
*/
void SP_trigger_push( svg_base_edict_t *self ) {
