...
*/
void trigger_elevator_use( svg_edict_t *self, svg_edict_t *other, svg_edict_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
    svg_edict_t *target;
...
void trigger_elevator_init( svg_edict_t *self ) {
...
void SP_trigger_elevator( svg_edict_t *self ) {
