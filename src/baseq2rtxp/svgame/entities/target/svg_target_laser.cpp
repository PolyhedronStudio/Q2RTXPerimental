...
*   @brief
**/
//DEFINE_MEMBER_CALLBACK_PAIN( svg_target_laser_t, onPain )( svg_target_laser_t *self, svg_base_edict_t *other, const float kick, const int32_t damage, const entity_damageflags_t damageFlags  ) -> void { }
/**
*   @brief
**/
