...
*   @brief
**/
static void light_off( svg_base_edict_t *self ) {
...
*   @brief
**/
static void light_on( svg_base_edict_t *self ) {
    //if ( SVG_HasSpawnFlags( self, START_OFF ) ) {
...
*   @brief
**/
static void light_toggle( svg_base_edict_t *self ) {
    if ( SVG_HasSpawnFlags( self, START_OFF ) ) {
        light_on( self );
    } else {
        light_off( self );
...
*   @brief
**/
void light_use( svg_base_edict_t *self, svg_base_edict_t *other, svg_base_edict_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
