...
*
**/
struct svg_light_light_t : public svg_base_edict_t {
    /**
    *
    *	Construct/Destruct.
    *
    **/
    //! Constructor. 
    svg_light_light_t() = default;
    //! Constructor for use with constructing for an cm_entity_t *entityDictionary.
    svg_light_light_t( const cm_entity_t *ed ) : Super( ed ) { };
    //! Destructor.
    virtual ~svg_light_light_t() = default;
    ...
    *   @brief  Spawn.
    **/
    DECLARE_MEMBER_CALLBACK_SPAWN( svg_light_light_t, onSpawn );
    /**
    *   @brief  Post-Spawn.
    **/
    //DECLARE_MEMBER_CALLBACK_POSTSPAWN( svg_light_light_t, onPostSpawn );
    /**
    *   @brief  Thinking.
    **/
    //DECLARE_MEMBER_CALLBACK_THINK( svg_light_light_t, onThink );
    //DECLARE_MEMBER_CALLBACK_THINK( svg_light_light_t, thinkExplode );

    /**
    *   @brief  Touched.
    **/
    //DECLARE_MEMBER_CALLBACK_TOUCH( svg_light_light_t, onTouch );
    /**
    *   @brief
    **/
    DECLARE_MEMBER_CALLBACK_USE( svg_light_light_t, onUse );
    ///**
    //*   @brief
    //**/
    //DECLARE_MEMBER_CALLBACK_PAIN( svg_light_light_t, onPain );
    ///**
    //*   @brief
    //**/
    //DECLARE_MEMBER_CALLBACK_DIE( svg_light_light_t, onDie );
