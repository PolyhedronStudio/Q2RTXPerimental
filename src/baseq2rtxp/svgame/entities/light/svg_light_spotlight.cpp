...
*	@brief
**/
void spotlight_think( svg_base_edict_t *self ) {
...
*	@brief	
**/
void spotlight_use( svg_base_edict_t *self, svg_base_edict_t *other, svg_base_edict_t *activator, const entity_usetarget_type_t useType, const int32_t useValue ) {
