...
**/
svg_base_edict_t *SVG_Util_CreateTempEventEntity( const Vector3 &origin, const sg_entity_events_t event, const int32_t eventParm0, const int32_t eventParm1, 
	const bool snapOrigin = false, const QMTime eventDuration = QMTime::FromMilliseconds( EVENT_VALID_MSEC ) );
