...
**/
void SVG_Command_Give_f(svg_entity_t *ent)
{
    char        *name;
    const gitem_t     *it;
    int         index;
...
*   @note   argv(0) god
**/
void SVG_Command_God_f(svg_entity_t *ent)
{
    if ((deathmatch->value || coop->value) && !sv_cheats->value) {
        gi.cprintf(ent, PRINT_HIGH, "You must run the server with '+set cheats 1' to enable this command.\n");
        return;
...
**/
void SVG_Command_Notarget_f(svg_entity_t *ent)
{
    if ((deathmatch->value || coop->value) && !sv_cheats->value) {
        gi.cprintf(ent, PRINT_HIGH, "You must run the server with '+set cheats 1' to enable this command.\n");
        return;
...
*   @note   argv(0) noclip
**/
void SVG_Command_Noclip_f(svg_entity_t *ent)
{
    if ((deathmatch->value || coop->value) && !sv_cheats->value) {
        gi.cprintf(ent, PRINT_HIGH, "You must run the server with '+set cheats 1' to enable this command.\n");
        return;
...
==================
*/
void SVG_Command_UseItem_f(svg_entity_t *ent) {
...
==================
*/
void SVG_Command_Drop_f(svg_entity_t *ent) {
    const char *s = gi.args();
    const gitem_t *it = SVG_FindItem(s);
    if (!it) {
        gi.cprintf(ent, PRINT_HIGH, "unknown item: %s\n", s);
...
=================
*/
void SVG_Command_Inven_f(svg_entity_t *ent)
{
    int         i;
    svg_client_t   *cl;
...
=================
*/
void SVG_Command_InvUseSelectedItem_f(svg_entity_t *ent)
{
    gitem_t     *it;
...
=================
*/
void SVG_Command_WeapPrev_f(svg_entity_t *ent)
{
    svg_client_t   *cl;
    int         i, index;
    gitem_t     *it;
...
=================
*/
void SVG_Command_WeapNext_f(svg_entity_t *ent)
{
    svg_client_t   *cl;
    int         i, index;
    gitem_t     *it;
...
=================
*/
void SVG_Command_WeapLast_f(svg_entity_t *ent)
{
    svg_client_t   *cl;
    int         index;
    gitem_t     *it;
...
=================
*/
void SVG_Command_WeapFlare_f(svg_entity_t* ent) {
...
=================
*/
void SVG_Command_InvDrop_f(svg_entity_t *ent) {
    gitem_t     *it;
...
=================
*/
void SVG_Command_Kill_f(svg_entity_t *ent)
{
...
=================
*/
void SVG_Command_PutAway_f(svg_entity_t *ent)
{
...
=================
*/
void SVG_Command_Players_f(svg_entity_t *ent)
{
    int     i;
    int     count;
    char    small[64];
...
static bool FloodProtect(svg_entity_t *ent)
{
	int     i;
	//svg_entity_t *other;
	//char    text[ 2048 ];
...
==================
*/
void SVG_Command_Say_f(svg_entity_t *ent, bool team, bool arg0)
{
    int     j;
    svg_entity_t *other;
    char    text[2048];
...
**/
void SVG_Command_Score_f( svg_entity_t *ent ) {
    ent->client->showinventory = false;
    ent->client->showhelp = false;
...
void SVG_Command_PlayerList_f(svg_entity_t *ent)
{
    int i;
    char st[80];
    char text[1400];
