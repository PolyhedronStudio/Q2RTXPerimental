...
void weapon_fists_primary_fire( svg_edict_t *ent ) {
    vec3_t      start;
...
*   @brief  
**/
void weapon_fists_secondary_fire( svg_edict_t *ent ) {
    Vector3     start;
    Vector3     forward, right;
    int         damage = 1;
    int         kick = 8;
...
**/
static void Weapon_Fists_ProcessUserInput( svg_edict_t *ent ) {
