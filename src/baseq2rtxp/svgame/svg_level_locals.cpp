...
SAVE_DESCRIPTOR_FIELDS_BEGIN( svg_level_locals_t )
    ...
    SAVE_DESCRIPTOR_DEFINE_FIELD_SIZE( svg_level_locals_t, mapNameDescriptor, SD_FIELD_TYPE_ZSTRING, MAX_QPATH ),
    ...
    SAVE_DESCRIPTOR_DEFINE_FIELD( svg_level_locals_t, intermissionState.engagedFrameNumber, SD_FIELD_TYPE_INT64 ),
    SAVE_DESCRIPTOR_DEFINE_FIELD( svg_level_locals_t, intermissionState.changemap, SD_FIELD_TYPE_LSTRING ),
    SAVE_DESCRIPTOR_DEFINE_FIELD( svg_level_locals_t, intermissionState.shouldExit, SD_FIELD_TYPE_INT64 ),
    SAVE_DESCRIPTOR_DEFINE_FIELD( svg_level_locals_t, intermissionState.cameraOrigin, SD_FIELD_TYPE_VECTOR3 ),
    SAVE_DESCRIPTOR_DEFINE_FIELD( svg_level_locals_t, intermissionState.cameraAngles, SD_FIELD_TYPE_VECTOR3 ),
