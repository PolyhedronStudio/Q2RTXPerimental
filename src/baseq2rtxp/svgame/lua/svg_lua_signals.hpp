...
static const bool SVG_Lua_SignalOut( sol::state_view &stateView, svg_base_edict_t *ent, svg_base_edict_t *other, svg_base_edict_t *activator, const char *signalName, const svg_signal_argument_array_t &signalArguments, const svg_lua_callfunction_verbosity_t verbosity = LUA_CALLFUNCTION_VERBOSE_MISSING, const Rest&&... rest ) {
	// False by default:
