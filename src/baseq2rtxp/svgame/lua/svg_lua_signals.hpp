...
static const bool SVG_Lua_SignalOut( lua_State *L, edict_t *ent, edict_t *activator, const std::string &signalName, const Rest&... rest ) {
	// False by default:
	...
	// Call function.
	executedSuccessfully = LUA_CallFunction( L, functionName, 1, ent, activator, signalName, rest... );
