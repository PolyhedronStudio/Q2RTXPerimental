...
//static inline void LUA_CallFunction_PushStackValue( lua_State *L, const svg_edict_t *e, const Rest&... rest ) {
...
**/
template <typename RetType, typename... Rest>
static const bool LUA_CallLuaNameEntityFunction( svg_edict_t *ent, const std::string callBackName, sol::state_view &stateView,
	RetType &returnValue,
	// WID: TODO: Do proper argument inspectations perhaps?
	//const int32_t numExpectedArgs = 0, const int32_t numReturnValues = 0,
	const Rest&... rest ) {
