...
**/
void SVG_Player_Weapon_Drop( svg_entity_t *ent, const gitem_t *inv );
/**
*   @brief  Will prepare a switch to the newly passed weapon.
**/
void SVG_Player_Weapon_Use( svg_entity_t *ent, const gitem_t *inv );
/**
...
**/
void SVG_Player_Weapon_SwitchMode( svg_entity_t *ent, const weapon_mode_t newMode, const weapon_mode_animation_t *weaponModeAnimations, const bool force );
/**
