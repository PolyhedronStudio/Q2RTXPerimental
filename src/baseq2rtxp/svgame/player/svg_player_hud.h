...
*   @brief
**/
void SVG_HUD_MoveClientToIntermission( svg_edict_t *client );
/**
...
**/
void SVG_HUD_DeathmatchScoreboardMessage( svg_edict_t *ent, svg_edict_t *killer, const bool sendAsReliable = false );