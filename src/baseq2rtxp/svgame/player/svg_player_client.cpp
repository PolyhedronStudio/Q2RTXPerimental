...
**/
void SVG_Client_BeginDeathmatch( edict_t *ent ) {
    // Init Edict.
    SVG_InitEdict( ent );
...
**/
void SVG_Client_BeginLoadGame( edict_t *ent ) {
...
**/
void SVG_Client_BeginNewBody( edict_t *ent ) {
...
**/
void Client_ClearUseTargetHint( edict_t *ent, svg_client_t *client, edict_t *useTargetEntity ) {
    // Nothing for display.
...
**/
const bool SVG_Client_UpdateUseTargetHint( edict_t *ent, svg_client_t *client, edict_t *useTargetEntity ) {
    // We got an entity.
