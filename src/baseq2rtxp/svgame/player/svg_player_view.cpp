...
static  svg_entity_t *current_player;
...
**/
void SVG_CheckClientPlayerstateEvents( const svg_entity_t *ent, player_state_t *ops, player_state_t *ps );
...
===============
*/
static void P_DamageFeedback( svg_entity_t *player ) {
	float   side;
	int32_t   r, l;
...
===============
*/
static void P_CalculateViewOffset( svg_entity_t *ent ) {
	//float *angles;
	//float       bob;
	float       ratio;
	//float       delta;
...
*/
// WID: Moved to CLGame.
//void SV_CalculateGunOffset( svg_entity_t *ent ) {
//	int     i;
//	float   delta;
//
...
=============
*/
static void P_CalculateBlend( svg_entity_t *ent ) {
	QMTime remaining;
...
===============
*/
void SVG_SetClientEffects( svg_entity_t *ent ) {
	ent->s.effects = 0;
	ent->s.renderfx = 0;
...
===============
*/
void SVG_SetClientEvent( svg_entity_t *ent ) {
...
===============
*/
void SVG_SetClientSound( svg_entity_t *ent ) {
...
void SVG_SetClientFrame( svg_entity_t *ent ) {
...
**/
void SVG_Client_BeginServerFrame( svg_entity_t *ent ) {
	svg_client_t *client;
	int32_t buttonMask;
...
**/
void SVG_Client_EndServerFrame( svg_entity_t *ent ) {
	int     i;
