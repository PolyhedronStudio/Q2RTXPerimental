...
*   @brief  
**/
void SVG_Client_TraceForUseTarget( edict_t *ent, svg_client_t *client, const bool processUserInput = false ) {
...
**/
static void ClientUpdateUserInput( edict_t *ent, svg_client_t *client, usercmd_t *userCommand ) {
...
**/
static const bool ClientCheckIntermission( edict_t *ent, svg_client_t *client ) {
...
**/
static void ClientRunPlayerMove( edict_t *ent, svg_client_t *client, usercmd_t *userCommand, pmove_t *pm, pmoveParams_t *pmp ) {
    // NoClip/Spectator:
    if ( ent->movetype == MOVETYPE_NOCLIP ) {
...
**/
static const Vector3 ClientPostPlayerMove( edict_t *ent, svg_client_t *client, pmove_t &pm ) {
...
**/
static void ClientProcessTouches( edict_t *ent, svg_client_t *client, pmove_t &pm, const Vector3 &oldOrigin ) {
