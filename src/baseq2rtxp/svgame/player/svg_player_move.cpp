...
static const cm_trace_t q_gameabi SV_PM_Trace( const vec3_t start, const vec3_t mins, const vec3_t maxs, const vec3_t end, const void *passEntity, const contents_t contentMask ) {
    ...
    return gi.trace( start, mins, maxs, end, (svg_entity_t *)passEntity, contentMask );
}
/**
...
*   @brief  
**/
void SVG_Client_TraceForUseTarget( svg_entity_t *ent, svg_client_t *client, const bool processUserInput = false ) {
...
**/
static void ClientUpdateUserInput( svg_entity_t *ent, svg_client_t *client, usercmd_t *userCommand ) {
...
**/
static const bool ClientCheckIntermission( svg_entity_t *ent, svg_client_t *client ) {
...
**/
void P_FallingDamage( svg_entity_t *ent, const pmove_t &pm ) {
    int	   damage;
    vec3_t dir;
...
**/
static void ClientRunPlayerMove( svg_entity_t *ent, svg_client_t *client, usercmd_t *userCommand, pmove_t *pm, pmoveParams_t *pmp ) {
    // NoClip/Spectator:
    if ( ent->movetype == MOVETYPE_NOCLIP ) {
...
**/
static const Vector3 ClientPostPlayerMove( svg_entity_t *ent, svg_client_t *client, pmove_t &pm ) {
...
**/
static void ClientProcessTouches( svg_entity_t *ent, svg_client_t *client, pmove_t &pm, const Vector3 &oldOrigin ) {
...
**/
void SVG_Client_Think( svg_entity_t *ent, usercmd_t *ucmd ) {
