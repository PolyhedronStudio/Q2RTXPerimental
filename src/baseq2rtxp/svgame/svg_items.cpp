...
//void Weapon_Blaster(svg_entity_t *ent);
//void Weapon_Shotgun(svg_entity_t *ent);
void Weapon_Fists( svg_entity_t *ent, const bool processUserInputOnly );
void Weapon_Fists_Precached( const gitem_t *item );
void Weapon_Pistol( svg_entity_t *ent, const bool processUserInputOnly );
void Weapon_Pistol_Precached( const gitem_t *item );
//void Weapon_SuperShotgun(svg_entity_t *ent);
//void Weapon_Machinegun(svg_entity_t *ent);
//void Weapon_Chaingun(svg_entity_t *ent);
//void Weapon_HyperBlaster(svg_entity_t *ent);
//void Weapon_RocketLauncher(svg_entity_t *ent);
//void Weapon_Grenade(svg_entity_t *ent);
//void Weapon_GrenadeLauncher(svg_entity_t *ent);
//void Weapon_Railgun(svg_entity_t *ent);
//void Weapon_BFG(svg_entity_t *ent);
//void Weapon_FlareGun(svg_entity_t *ent);
...
*   @brief
**/
void SVG_Inventory_SelectNextItem( svg_entity_t *ent, int itflags ) {
    svg_client_t *cl;
    int         i, index;
    gitem_t *it;
...
*   @brief
**/
void SVG_Inventory_SelectPrevItem( svg_entity_t *ent, int itflags ) {
    svg_client_t *cl;
    int         i, index;
    gitem_t *it;
...
**/
void SVG_Inventory_ValidateSelectedItem( svg_entity_t *ent ) {
    svg_client_t *cl;
...
*
**/
void DoRespawn(svg_entity_t *ent)
{
...
*   @brief
**/
void Drop_General(svg_entity_t *ent, gitem_t *item)
{
    Drop_Item(ent, item);
...
**/
const bool Pickup_Ammo(svg_entity_t *itemEntity, svg_entity_t *other) {
...
*   @brief  Drops ammo.
**/
void Drop_Ammo(svg_entity_t *ent, const gitem_t *item) {
    int32_t index = ITEM_INDEX(item);
    svg_entity_t *dropped = Drop_Item(ent, item);
...
*   @brief
**/
void MegaHealth_think(svg_entity_t *self)
{
...
*   @brief
**/
const bool Pickup_Health(svg_entity_t *ent, svg_entity_t *other)
{
...
*   @brief
**/
void drop_temp_touch(svg_entity_t *ent, svg_entity_t *other, const cm_plane_t *plane, cm_surface_t *surf)
{
    if (other == ent->owner)
        return;
...
*   @brief
**/
void drop_make_touchable(svg_entity_t *ent)
{
...
*   @brief
**/
void Use_Item(svg_entity_t *ent, svg_entity_t *other, svg_entity_t *activator, const entity_usetarget_type_t useType, const int32_t useValue )
{
    ent->svflags &= ~SVF_NOCLIENT;
    ent->use = NULL;
