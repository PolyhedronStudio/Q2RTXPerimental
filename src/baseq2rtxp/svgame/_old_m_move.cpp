...
*/
#define DI_NODIR    -1
void SV_NewChaseDir(svg_entity_t *actor, svg_entity_t *enemy, float dist)
{
    float   deltax, deltay;
    float   d[3];
...
======================
*/
bool SV_CloseEnough(svg_entity_t *ent, svg_entity_t *goal, float dist)
{
    int     i;
...
======================
*/
void M_MoveToGoal(svg_entity_t *ent, float dist)
{
    svg_entity_t     *goal;
