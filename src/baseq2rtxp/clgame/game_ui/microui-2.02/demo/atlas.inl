...
static constexpr int32_t ATLAS_WHITE = MU_ICON_MAX;
static constexpr int32_t ATLAS_FONT = MU_ICON_MAX + 1;

static constexpr int32_t ATLAS_WIDTH = 128;
static constexpr int32_t ATLAS_HEIGHT = 128;

static constexpr unsigned char clg_gameui_atlas_texture[ ATLAS_WIDTH * ATLAS_HEIGHT ] = {
...
static constexpr mu_Rect clg_gameui_atlas[ ] = {
